...
public class ConcerttoursManager extends GeneratedConcerttoursManager
{
	...
	{
		return (ConcerttoursManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ConcerttoursConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ConcerttoursManager called. " + getTenant().getTenantID());
		}
	}
