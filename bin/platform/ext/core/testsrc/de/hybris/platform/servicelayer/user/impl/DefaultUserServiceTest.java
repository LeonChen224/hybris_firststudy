...
public class DefaultUserServiceTest
{
	...
	{
		// mock user dao
		this.userDao = Mockito.mock(DefaultUserDao.class);

		// mock user group dao
		this.userGroupDao = Mockito.mock(UserGroupDao.class);

		// mock title dao
		this.titleDao = Mockito.mock(TitleDao.class);
		...
		this.userService.setUserGroupDao(userGroupDao);
		this.userService.setTitleDao(titleDao);
		this.userService.setSessionService(sessionService);
		this.userService.setSearchRestrictionService(srs);
		this.userService.setPasswordEncoderService(passwordEncoderService);
