...
public interface CategoryService
{
	...
	/**
	 * @deprecated since 4.3, please use {@link #getPathForCategory(CategoryModel)}.
	 * 
	 *             Returns the path from the given {@link CategoryModel} down to the root category. <b>This method should
	 *             be used only in cases without multiple super-categories; otherwise it cannot be predicted which path
	 *             is chosen!</b><br/>
	 * 
	 * @param category
	...
	/**
	 * Returns the path from root category to the given {@link CategoryModel}.
	 * 
	 * To get all super-categories use {@link CategoryModel#getSupercategories()}.
	 * 
	 * @param category
	 *           the {@link CategoryModel}
	 * 
