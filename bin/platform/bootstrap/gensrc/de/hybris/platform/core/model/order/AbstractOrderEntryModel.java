 ...
 * --- Generated at 2018-3-14 10:36:31                          ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 *  
...
public class AbstractOrderEntryModel extends ItemModel
{
	...
	{
		return getPersistenceContext().getPropertyValue(CALCULATED);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(GIVEAWAY);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(REJECTED);
	}
